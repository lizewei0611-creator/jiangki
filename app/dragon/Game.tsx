...
import { addRank, rankPosition, useRanks, RankEntry } from "@/lib/ranks";
...
function Leaderboard({ ranks }: { ranks: RankEntry[] }) {
  ...
  return (
    <div className="pixel-border mt-8 bg-arcade-2 p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h3 className="pixel-font text-[11px] text-pac">LEADERBOARD · TOP {list.length}</h3>
        <select
          value={filter}
